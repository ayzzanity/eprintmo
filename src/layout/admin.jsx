...
const AdminDrawer = () => {
    ...
    return (
      ...
      >
        ...
        <List>
        <Divider />
          <Link to="/admin/status" className={classes.link}>
          ...
          <Link to="/admin/request" className={classes.link}>
            <ListItem button className={classes.bg}>
              <ListItemIcon>
          ...
          <Link to="/admin/rates" className={classes.link}>
            <ListItem button className={classes.bg}>
              <ListItemIcon>
          ...
          <Link to="/admin/queue" className={classes.link}>
            <ListItem button className={classes.bg}>
              <ListItemIcon>
                <AccountCircleIcon className={classes.icon} />
              </ListItemIcon>
              <ListItemText primary={"Manage Printing Queues"} />
            </ListItem>
          </Link>
